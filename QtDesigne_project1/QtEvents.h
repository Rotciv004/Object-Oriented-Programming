...
private:
	...
	QListWidget* eventListWidget_user;
	QListWidget* selectedEvents;

	QLineEdit* month_user;

	QPushButton* filterByMonth;
	QPushButton* addButton_user;
	QPushButton* viewSelected_events;
